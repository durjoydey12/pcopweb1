...
<div class="row justify-content-center">
        ...
        <div class="col-md-5">
        <h1><b>Developer Page</b></h1><hr><br><br>
        <form action="developer_insert.php" method="POST"  enctype="multipart/form-data">
...
<div class="row justify-content-center">
        <div class="col-md-5">  
                      <h5> <a class="btn btn-info" href="developer_users.php">  <b> users page</b></a>  </h5>        
        </div>
