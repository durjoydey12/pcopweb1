                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                        ...
                        <td>
                            ...
                            <a href="delete_outsourcisng_image.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                        </td>
                     </tr>
                        <?php endwhile; ?>
                    </tbody>
